...
public class CucumberReportParserTest {
    ...
    public void shouldFilterFile() throws Exception {
        ...
        File newFile = CucumberFileUtil.filterCucumberFiles(oldFile, TMP_FOLDER, true, System.out);
    ...
    public void shouldFailWithWrongFormat() throws Exception {
        ...
        CucumberFileUtil.filterCucumberFiles(oldFile, TMP_FOLDER, true, System.out);
