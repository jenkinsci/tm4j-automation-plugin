...
public class Constants {
    public static final String NAME_POST_BUILD_ACTION = "Zephyr: Publish Test Results";
    public static final String NAME_DOWNLOAD_BUILD_STEP = "Zephyr: Download Feature Files";
    public static final String ADD_ZEPHYR_GLOBAL_CONFIG = "Please configure at least one Jira instance in the global configuration";
    ...
    public static final String ZEPHYR_OUTPUT_RESULT_FOR_JUNIT = "Zephyr Output Result For JUnit";
    ...
    public static final String CUSTOM_FORMAT_FILE = "zephyr_result.json";
    ...
    public static final String ZEPHYR_GLOBAL_CONFIGURATION = "Zephyr configuration";
    private static final String PLUGIN_NAME = "[Zephyr]";
